    ...
    return (
        ...
        <div className="flex  lg:flex-row flex-col-reverse items-center justify-between ">
                ...
                <div className=" mx-auto md:w-[500px] w-[280px]  shadow-lg shadow-cyan-500/50 bg-white">
                    <form onSubmit={handleSubmit(onSubmit)} className="px-12 py-5">
                        ...
                        <div className="space-y-5">
                            ...
                            <label htmlFor="email" className="block">Already have an Account? Go to <Link to='/login'><span className="text-red-600">Login Page</span></Link></label>
                        </div>
                        {/* button type will be submit for handling form submission*/}
                        <button type="submit" className="my-5 btn bg-black text-white hover:bg-[#90dddcff]">Register</button>
                    </form>
            ...
            <div className="lg:w-1/2 overflow-hidden flex-1 ">
                <img src="https://i.ibb.co/1rLwF68/bandarbans.jpg" className="w-full  lg:min-h-screen   bg-gray-400  object-cover transform transition-transform ease-in-out duration-300 hover:scale-110" alt="hero navigate ui" />
            </div>
        </div>
