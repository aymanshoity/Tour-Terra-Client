...
const MeetTourGuideSingle = ({ guide }) => {
    const { tourGuideName, tourGuideEmail,profilePicture, _id } = guide
    const svgs = [
    ...
    return (
        <div>
            <div className="p-8 shadow-lg w-[250px]  font-sans rounded-xl space-y-4 my-10 flex flex-col justify-center items-center mx-auto shadow-[#90dddcff] bg-white">

                <div className="relative group">
                    <img className="w-[110px] h-[110px] bg-slate-500 object-cover rounded-full" src={profilePicture} alt="card navigate ui" />
                </div>

                <div className="text-center space-y-1">
                    <h1 className="text-2xl text-gray-700">{tourGuideName}</h1>
                ...
                <Link to={`/tourGuide/${_id}`}>
                    <button className="hover:bg-[#90dddcff] hover:scale-95 font-medium  hover:shadow-xl btn bg-black  text-white shadow-[#90dddcff] t duration-500">View Profile</button>
                </Link>
            </div>
        </div>
    );
...
export default MeetTourGuideSingle;